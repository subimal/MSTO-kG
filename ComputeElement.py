...
# choose your element
assert len(sys.argv)==2, '''Usage: python ComputeElement.py <element>
Example: $ python ComputeElement.py Li
...
for passes in range(3):
    for k in range(2, 13):
        ...
        pop2, gen, en = OptimizeElement(mol, Nmax, fname, trials=30, tol=tol, trials_mu=20, trials_co=20)
        print()
        print("Trying an aggressive refinement")
        AggressiveRefinement(pop2[0][1], fname, trials=20, tol=tol, fci=True, itermax=200)
        print()
